	...
	return (
		<StyledWrapper>
			...
			<StyledBody>
				...
				{step === 2 && (
					<SignUpGender gender={gender} onChangeGender={onChangeGender} onChangeStep={() => setStep(3)} />
				)}
				{step === 3 && (
					<SignUpBirthday name={name} gender={gender} year={year} onChangeYear={onChangeYear} month={month} onChangeMonth={onChangeMonth} day={day} onChangeDay={onChangeDay} onChangeStep={() => setStep(4)} />
				)}
				{step === 4 && (
					<SignUpComplete name={name} />
				)}
			</StyledBody>
		</StyledWrapper>
	);
...
const SignUpBirthday: React.FC<SignUpBirthdayProps> = ({ name, gender, year, onChangeYear, month, onChangeMonth, day, onChangeDay, onChangeStep }) => {
